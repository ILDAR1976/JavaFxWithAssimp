...
public class LwjglTexture {
     ...
     * @throws Exception
     */
    public LwjglTexture(int width, int height, int pixelFormat) throws Exception {
    ...
    public LwjglTexture(String fileName, int numCols, int numRows) throws Exception {
        this(fileName);
        this.numCols = numCols;
        this.numRows = numRows;
    }

    public LwjglTexture(String fileName) throws Exception {
        this(Utils.ioResourceToByteBuffer(fileName, 1024));
    }

    public LwjglTexture(ByteBuffer imageData) {
